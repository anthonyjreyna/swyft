  ...
  if (hook) {
    try {
      await fetch(hook, {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          // Keys match the Google Sheet column headers exactly so the
          // Google Sheets node can map them automatically.
          ...
          "Sq Ft": lead.squareFootage != null ? lead.squareFootage : "",
          "Year Built": lead.yearBuilt != null ? lead.yearBuilt : "",
          Latitude: lead.lat != null ? lead.lat : "",
          Longitude: lead.lng != null ? lead.lng : "",
          "Map Link": mapUrl || "",
          Source: "Website",
          "Phone Verified": true,
        }),
